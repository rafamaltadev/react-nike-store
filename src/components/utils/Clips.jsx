  ...
  return (
    <>
      <div className="relative h-28 w-32 rounded-xl overflow-hidden group cursor-pointer transition-all duration-300 lg:w-28 md:w-24 sm:w-16 lg:h-24 md:h-20 sm:h-14">
        ...
        />
        <div className="absolute top-11 left-11 lg:top-8 lg:left-9 sm:top-4 sm:left-5 right-0 opacity-100 z-[100] w-9 h-9 md:w-6 md:h-6 flex items-center justify-center">
          <PlayIcon className="icon-style md:w-4 md:h-4 text-slate-100" />
