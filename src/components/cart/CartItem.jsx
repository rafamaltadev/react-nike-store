      ...
      <div className="flex items-center justify-between w-full px-5">
        <div className="flex items-center gap-5">
          ...
          >
            ...
            />
            <div className="absolute right-1 top-1 blur-theme-effect bg-white/80 text-black text-sm px-2 py-1 rounded font-semibold">
              R${price}
            </div>
          </div>
          <div className="grid items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="bg-theme-cart rounded text-white font-medium lg:text-base w-7 h-7 lg:h-6 lg:w-6 flex items-center justify-center">
                {cartQuantity}
              </div>
              <button
                type="button"
        ...
        <div className="grid items-center gap-5">
          <div className="grid items-center justify-center">
            <h1 className="text-lg lg:text-base text-slate-900 font-semibold">
              R${price * cartQuantity}
            </h1>
          </div>
          <div className="grid items-center justify-center">
            <button
