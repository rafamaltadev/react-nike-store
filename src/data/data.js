...
const heroapi = {
  ...
  sociallinks: [
    { icon: linkedin, url: "https://www.linkedin.com/in/rafamalta/" },
    { icon: github, url: "https://github.com/rafamaltadev?tab=repositories" },
    { icon: instagram, url: "https://www.instagram.com/o_rafamalta/" },
    { icon: twitter, url: "https://twitter.com/o_rafamalta" },
    { icon: youtube, url: "https://www.youtube.com/@RafaMalta" },
  ],
};
...
const sneaker = {
  heading: "LANÇAMENTOS",
  title: "LANÇAMENTO DO TÊNIS NIKE SNEAKERS AIR",
  text: "O esplendor vive no Tênis Nike Sneakers Air Lancing, a bola de basquete OG que dá um novo toque ao que você conhece melhor: sobreposições costuradas duráveis, acabamentos limpos e a quantidade perfeita de brilho para fazer você brilhar.",
  btn: "Saiba Mais",
